...
$attachments = WCOA_Attachment::get_all_by_order($current_order_id);
...
?>
    ...
    <div class="<?php print $wcoa_visibility_class; ?>" id="wcoa-all-attachments-content">
        ...
        <ul id="wcoa-order-attachments-list">
            ...
            { ?>
                <li title="<?php _e('Attachment Preview'); ?>" class="wcoa-new-item"><a target="_blank" href="<?php print $item['guid']; ?>"><?php print $item['post_title']; ?></a></li> <?php
			} ?>
        </ul>
    </div>
<?php
