...
define( 'WCOA_PLUGIN_VERSION', '2.2.2' );
...
function wcoa_woocommerce_verification() { ?>
...
require_once WCOA_PLUGIN_DIR . 'bootstrap.php';

register_activation_hook( __FILE__, ['WCOA_Admin', 'restart_rewrite'] );
