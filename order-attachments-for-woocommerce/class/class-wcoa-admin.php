...
class WCOA_Admin
{
    ...
    {
        $screen = class_exists(\Automattic\WooCommerce\Internal\DataStores\Orders\CustomOrdersTableController::class ) && wc_get_container()
            ->get(\Automattic\WooCommerce\Internal\DataStores\Orders\CustomOrdersTableController::class )->custom_orders_table_usage_is_enabled()
	...
	public static function erase_metadata_after_delete_attachment(int $attachment_id): void
    {
		...
		delete_post_meta($order_id, '_wcoa_attachment_id', $attachment_id);
    ...
    public function verify_hpos(): void
    {
        ...
        {
            $this->hpos_is_enabled = \Automattic\WooCommerce\Utilities\OrderUtil::custom_orders_table_usage_is_enabled();
        }

        if (class_exists(\Automattic\WooCommerce\Utilities\FeaturesUtil::class))
        {
            \Automattic\WooCommerce\Utilities\FeaturesUtil::declare_compatibility('custom_order_tables', WCOA_PLUGIN_PATH, true);
        }
    }
