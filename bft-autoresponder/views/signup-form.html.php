...
<div class="bft-form-group"><label><?php _e('Name:', 'broadfast')?></label> <input type="text" <?php if(!empty($require_name)) echo 'required';?> name="user_name" <?php if(!empty($allow_get) and !empty($name)) echo 'value="'.$name.'"';?>></div>
<div class="bft-form-group"><label><?php _e('Email:', 'broadfast')?></label> <input type="email" required name="email" <?php if(!empty($allow_get) and !empty($email)) echo 'value="'.$email.'"';?>></div>
