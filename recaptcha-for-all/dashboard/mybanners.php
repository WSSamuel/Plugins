...
_e('If you use & enjoy Recaptcha For All Plugin, please rate it on WordPress.org. It only takes a second and helps us keep the plugin free and maintained. Thank you!', 'recaptcha-for-all');
?>
<br /><br />
<a href="https://wordpress.org/support/plugin/recaptcha-for-all/reviews/#new-post" class="button button-medium button-primary"><?php _e('Rate', 'recaptcha-for-all'); ?></a>
<?php
