...
function nicejob_stories($atts) {
  ...
  ob_start();
  ?>
  <a class="nj-stories" href="<?php echo $a['review-url']; ?>/<?php echo $hash; ?>"<?php echo $params; ?>>powered by NiceJob</a><script type="text/javascript"<?php echo $nj_app.$nj_review; ?> src="<?php echo $js_url; ?>/js/sdk.min.js?id=<?php echo $hash; ?>" defer></script>
  <?php
  return ob_get_clean();
}
...
function nicejob_badge($atts) {
  ...
  ob_start();
  ?>
  <a class="nj-badge" href="<?php echo $a['review-url']; ?>/<?php echo $hash; ?>"<?php echo $params; ?>>powered by NiceJob</a><script type="text/javascript"<?php echo $nj_app.$nj_review; ?> src="<?php echo $js_url; ?>/js/sdk.min.js?id=<?php echo $hash; ?>" defer></script>
  <?php
  return ob_get_clean();
}
...
function nicejob_engage($atts) {
  ...
  ob_start();
  ?>
  <div class="nj-engage"<?php echo $params; ?>></div><script type="text/javascript"<?php echo $nj_app.$nj_review; ?> src="<?php echo $js_url; ?>/js/sdk.min.js?id=<?php echo $hash; ?>" defer></script>
  <?php
  return ob_get_clean();
}
...
function nicejob_lead($atts) {
  ...
  if($a['type']=='button') {
  ?>
    <button type="button" <?php echo $params; ?>><?php echo $a['text']; ?></button>
  <?php } else { ?>
    <a <?php echo $params; ?>><?php echo $a['text']; ?></a>
  <?php } ?>
  <script type="text/javascript"<?php echo $nj_app.$nj_review; ?> src="<?php echo $js_url; ?>/js/sdk.min.js?id=<?php echo $hash; ?>" defer></script>
  <?php
  return ob_get_clean();
}
...
function nicejob_options() {
  if(isset($_POST['submit']) && $_POST['nicejob_company_id']) {
    update_site_option('nicejob_company_id', $_POST['nicejob_company_id']);
  ...
  <div class="wrap">
    <!--h2>NiceJob</h2-->
    <p><?=settings_errors();?></p>
    <h3><img src="<?=plugin_dir_url(__FILE__)."/nicejob-logo.png"?>" style="width:150px;" /></h3>
    <form action="" method="POST">
      <div>
        <label for="nicejob-company-id">Company ID</label>
        <input id="nicejob-company-id" type="text" name="nicejob_company_id" value="<?=$company_id?>" style="width:200px;" />
...
function nicejob_admin_icon() {
  echo '<style>
    #adminmenu #toplevel_page_nicejob-nicejob .menu-icon-generic div.wp-menu-image:before {
      background: no-repeat url('.plugin_dir_url(__FILE__)."/nicejob-button-40-white.png".') 0px 6px scroll;
