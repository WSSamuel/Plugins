...
Send your Gravity Forms Data Instantly to your Connected Google Sheets In real-time.Easily manage your Gravity Forms data without worrying about any loss of information.
...
6. Get Sheet and Tab Id from the URL.
7. Google Sheet settings page with input box Sheet Name, Sheet Id, Tab Name, Tab Id.
8. Add Gravity Forms field name to the Google Sheet headers.
9. Google Sheet headers with form submitted data.
