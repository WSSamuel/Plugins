...
class Gfgsc_googlesheet {
   ...
   public static function preauth($access_code) {
      ...
      $clientId = ($newClientSecret == 1) ? Gfgsc_googlesheet::clientId_web : Gfgsc_googlesheet::clientId_desk;
      $clientSecret = ($newClientSecret == 1) ? Gfgsc_googlesheet::clientSecret_web : Gfgsc_googlesheet::clientSecret_desk;
