...
<div class="gform-tab-container">
    <div class="gform-card gform-tab-content">
        ...
        <div class="inside-tab">
            <div class="gravityform-gs-alert-card <?php if (!empty(get_option('gfgs_token')) && get_option('gfgs_token') !== "") echo 'hidden'; ?>">
                <?php if (empty($Code)) { ?>
            ...
            <div class="gs-integration-layout">
                ...
                <?php } else { 
                    ...
                    <?php if (empty($Code)) { ?>
                        <a href="https://oauth.gsheetconnector.com/index.php?client_admin_url=<?php echo $redirct_uri; ?>&plugin=woocommercegsheetconnector" class="button_gravityformgsc">
                            <img class="custom-image" src="<?php echo GRAVITY_GOOGLESHEET_URL ?>/assets/image/btn_google_signin_dark_pressed_web.gif" alt="Connect Now">
                        </a>
                    <?php } ?>
                    ...
                    <?php if (!empty($_GET['code'])) { ?>
                        <input type="button" name="save-code" id="save-code" value="<?php _e('Save', 'gsheetconnector-gravityforms'); ?>" class="custom-button button-primary" />
                    <?php } ?>
                <?php } ?>
