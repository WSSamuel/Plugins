...
define('GRAVITY_GOOGLESHEET_VERSION', '1.3.14');
define('GRAVITY_GOOGLESHEET_DB_VERSION', '1.3.14');
   ...
   public function run_on_upgrade() {
      try {
         ...
         $google_sheet_info = array(
            'version' => GRAVITY_GOOGLESHEET_ROOT,
    ...
    */
     public function grvt_connector_pro_plugin_action_links($links) {
        ...
        return array_merge(array(
            '<a href="' . admin_url('admin.php?page=gf_googlesheet') . '">' . __('Settings', 'gsheetconnector-gravityforms') . '</a>',
            '<a class="upgrade-link" href="https://www.gsheetconnector.com/gravity-forms-google-sheet-connector" target="_blank">' . __(' Upgrade to PRO')
                  ), $links);
     }
