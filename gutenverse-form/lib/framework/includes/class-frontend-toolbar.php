	...
	public function add_toolbar( $admin_bar ) {
		if ( is_user_logged_in() ) {
			...
			if ( in_array( 'administrator', $roles, true ) || in_array( 'editor', $roles, true ) ) {
				...
				$title = '<span><img src="' . esc_url( GUTENVERSE_FRAMEWORK_URL . '/assets/icon/icon-logo-dashboard.svg' ) . '"/>' . esc_html__( 'Gutenverse', 'gutenverse-form' ) . '</span>';
				...
				if ( ! defined( 'GUTENVERSE_PRO' ) ) {
					$admin_bar->add_menu(
						array(
							'id'    => 'gutenverse-pro',
							'title' => '<span class="gutenverse-pro-right">' . esc_html__( 'Gutenverse PRO', 'gutenverse-form' ) . '<img src="' . esc_url( GUTENVERSE_FRAMEWORK_URL . '/assets/icon/icon-crown.svg' ) . '"/> </span>',
