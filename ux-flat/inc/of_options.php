...
function uxf_of_options(){
    ...
    if ( uxf_pro_enabled() ) {
		$of_options[] = array(
			'name' => '',
			'type' => 'info',
			'desc' => '<p style="font-size:12px">Version: '.UXFP_VERSION.'<span style="background: #ff3030;" class="of-tag">PRO</span> | <a href="' . admin_url( 'admin.php?page=ux-flat-pro' ) . '">License</a> | <a target="_blank" rel="noopener" href="https://wpvnteam.com/ux-flat/doc/">Documentation</a></p>',
		);
    } else {
		$of_options[] = array(
			'name' => '',
			'type' => 'info',
			'desc' => '<p style="font-size:12px">Version: '.UXF_VERSION.'<span style="background: #72aee6;" class="of-tag">LITE</span> | <a target="_blank" rel="noopener" href="https://wpvnteam.com/ux-flat/">Go Pro</a> | <a targer="_blank" href="https://www.paypal.me/copvn" rel="nofollow">Donate to this plugin</a></p>',
		);
    }
